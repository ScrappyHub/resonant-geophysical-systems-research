...
$mgPath = Join-Path $mgDir ("{0}_rgsr_v12_1_admin_bootstrap_can_write.sql" -f $MigrationId)
...
Write-Host "✅ v12.1 ADMIN BOOTSTRAP APPLIED (CORE can_write gate)" -ForegroundColor Green
