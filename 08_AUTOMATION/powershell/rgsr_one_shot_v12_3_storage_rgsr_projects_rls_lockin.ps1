...
$mgPath = Join-Path $mgDir ("{0}_rgsr_v12_3_storage_rgsr_projects_rls.sql" -f $MigrationId)
...
Write-Host "✅ v12.3 applied (storage RLS: rgsr_projects private-by-default + published public read)" -ForegroundColor Green
