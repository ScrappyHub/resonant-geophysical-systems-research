...
$mgPath = Join-Path $mgDir ("{0}_rgsr_v11_2_faq_forum_research_lockin.sql" -f $MigrationId)
...
Write-Host "✅ v11.2 applied (FAQ topics + forum + research + filterability)" -ForegroundColor Green