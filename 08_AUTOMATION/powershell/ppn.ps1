...
switch ($Command) {
  ...
  'resonance-fast' {
    ...
    Write-Host "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Resonance FAST complete: $json" -ForegroundColor Green
    break
  }
  ...
  'init-run' {
    ...
    Write-Host "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Created Experiment: $ExperimentId" -ForegroundColor Green
  ...
  'ingest' {
    ...
    Write-Host "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Ingest complete: $ExperimentId" -ForegroundColor Green
    Write-Host " - RAW dir:      $rawDir" -ForegroundColor DarkGray
  ...
  'quicklook' {
    ...
    Write-Host "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Quicklook created: $mdPath" -ForegroundColor Green
    break
  }
  ...
  'resonance' {
    ...
    Write-Host "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Resonance complete: $json" -ForegroundColor Green
    break
  }
  ...
  'resonance-summary' {
    ...
    Write-Host "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Resonance summary: $ExperimentId" -ForegroundColor Green
  ...
  'resonance-plot' {
    ...
    Write-Host "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Resonance plots complete: $ExperimentId" -ForegroundColor Green
